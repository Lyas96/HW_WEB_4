          ...
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <div class="w3-container">
                <?php for ($i = 0; $i < count($experience); $i++): ?>
                    ...
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]['datestart'] ?> - <span
                    class="w3-tag w3-teal w3-round"> <?= $experience[$i]['dateend'] ?></span></h6>
